// app/(tabs)/cci.tsx
// Standalone CCI Follow-Up page — reached from the Home menu card.
...
const SUB_TABS: { key: SubTab; label: string; statsKey: string }[] = [
  { key: "in_transit", label: "🚚  In-Transit", statsKey: "cci_in_transit_total" },
  { key: "in_repair",  label: "🔧  In-Repair",  statsKey: "cci_in_repair_total"  },
];

export default function CCIScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 10 }]}>
        <Text style={styles.headerTitle}>CCI Follow-Up</Text>
        <Text style={styles.headerSub}>Store Visit</Text>
      </View>
